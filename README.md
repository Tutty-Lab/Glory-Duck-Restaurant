# Dienstplan & Stundenzettel — Glory Duck

Sonntagstr. 31, 10245 Berlin. Abgeleitet aus der Kylan-App (davor VietHaus,
Mrson, DongDo).
...
> **Annahmen, die noch bestätigt werden müssen.** Uhrzeit und Personenzahl der
> Stoßzeit hat der Betrieb nicht genannt – nur "Freitag und Samstag ist viel
> los, wir brauchen mehr Leute". Gesetzt sind daher **Fr/Sa 18:00–21:00 mit
> mindestens 2 Personen**, ohne Obergrenze. Ebenfalls geschätzt ist das Gewicht
> des **Sonntags**. Beides steht an je einer Stelle im Code
> (`PEAK_WINDOWS_BY_WEEKDAY` bzw. `DAY_WEIGHTS`).
...
1. **Einstellungen** – Firmenname, Anschrift, Monat, Jahr; **Arbeitszeit-Fenster
   je Wochentag + Feiertag** (giờ làm; Standard: täglich 12:00–22:30,
   **kein fester Schließtag**; mehrere Blöcke je Tag sind möglich).
...
- Schichtlängen: **3 bis 9 Stunden**. Vollzeit bekommt **nur 8 h** (Ansage des
  ...
  Längen, damit der Monat trotzdem exakt aufgeht. Teilzeit/Minijob 3..9 h.
