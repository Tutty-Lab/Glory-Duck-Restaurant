...
// und Samstag sind die vollen Tage und brauchen mehr Leute.
//
// ACHTUNG, hier steckt eine ANNAHME drin: genaue Uhrzeiten und Personenzahlen
// hat der Betrieb NICHT genannt. Gesetzt sind deshalb 18:00-21:00 als
// Abendspitze und "mindestens 2 Personen". Eine Obergrenze gibt es bewusst
// nicht (KEINE_OBERGRENZE) – gefordert war ja gerade "nhiều nhân viên".
// Sobald der Betrieb konkrete Zeiten nennt, ist das hier die einzige Stelle,
...
/**
 * Stoßzeiten je Wochentag. Kein Tag ist fest geschlossen; Feiertage werden wie
 * Sonntag behandelt – siehe effectiveWeekdayKey.
 */
